...
#define STRING_CONFIG_H_AUTHOR "(John Wiebe, Ender 3 Pro - SKR Mini E3 V3.0)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 26.41
    #define DEFAULT_Ki 2.41
    #define DEFAULT_Kd 72.35
  #endif
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 111.55
  #define DEFAULT_bedKi 21.45
  #define DEFAULT_bedKd 386.79
